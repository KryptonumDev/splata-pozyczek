...
export default function BlogSlider({ posts }) {
    ...
    return (
        <Wrapper>
            <Container>
                <h2 className="h4 arsenal" dangerouslySetInnerHTML={{ __html: 'Powiązane artykuły' }} />
                <ControlButtonsWrap>
                    <button aria-label="left arrow" onClick={() => { transform('left', x, maxButtonsTransform) }} className="control left">
                    ...
                    <button aria-label="right arrow" onClick={() => { transform('right', x, maxButtonsTransform) }} className="control right">
                        <svg width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
