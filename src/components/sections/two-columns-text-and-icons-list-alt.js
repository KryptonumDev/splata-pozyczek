        ...
        <Wrapper>
            <Container>
                <Intro>
                    ...
                    {text && <div className="h6 arsenal" dangerouslySetInnerHTML={{ __html: textParser(text) }} />}
                </Intro>
                <List>
                    {repeater.map((el, index) => (
                        <Item key={index} >
                            ...
                            <div className="text">
                                {el.title && <h3 className="title" dangerouslySetInnerHTML={{ __html: textParser(el.title) }} />}
