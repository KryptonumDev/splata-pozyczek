    ...
    return (
        <Wrapper>
            <Container>
                ...
                <InputPagination active={InputVal === page}>
                    ...
                    <Link onClick={e => { setCurrentPage(InputVal) }} to={InputVal === 1 ? pageUrl : pageUrl + '?page=' + InputVal} className="dark body1">Przejdź</Link>
                </InputPagination>
            </Container>
        </Wrapper>
    )
...
const Left = ({ url, setCurrentPage, currentPage }) => (
    <Link className={'left ' + (currentPage === 1 ? 'disabled' : '')} to={currentPage < 3 ? url : url + '?page=' + (currentPage - 1)} onClick={e => { setCurrentPage(currentPage === 1 ? 1 : currentPage - 1) }}>
...
const Right = ({ url, setCurrentPage, currentPage, maxPage }) => (
    <Link className={'right ' + (currentPage === maxPage ? 'disabled' : '')} to={currentPage > maxPage - 2 ? url + '?page=' + maxPage : url + '?page=' + (currentPage + 1)} onClick={e => { setCurrentPage(currentPage === maxPage ? maxPage : currentPage + 1) }}>
